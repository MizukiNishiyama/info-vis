...
if __name__ == "__main__":
    # Genius API トークンを設定
    genius_token = "K110u0XsYe7Cabie34_yR3d6d73OgkWcBmFGmFAarUPecjP0-A0EXLiBH8-EgUKZ"  # 適切なトークンを入力してください

    # 関数を実行
    get_lyrics_from_output_csv("./output/split_csv_files/tracks_rapper_part10.csv", genius_token, "./output/lyrics_output10.csv")