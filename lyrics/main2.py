...
if __name__ == "__main__":
    # Genius API トークンを設定
    genius_token = "Kt-03bqJOXdcu86nVVNCio5Jwu6Ik86RRRQDWKnLQ9vkMn2tPsdbyGy30pyDbK6X"  # 適切なトークンを入力してください

    # 関数を実行
    get_lyrics_from_output_csv("./output/split_csv_files/tracks_rapper_part2.csv", genius_token, "./output/lyrics_output2-2.csv")