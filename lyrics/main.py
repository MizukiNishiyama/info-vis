...
if __name__ == "__main__":
    # Genius API トークンを設定
    genius_token = "7q6YOSMqusnmi26X2hINB0izURIPqqNXKwO02daE0ZBmtZLLh-TOxs0roQSZg16N"  # 適切なトークンを入力してください

    # 関数を実行
    get_lyrics_from_output_csv("./output/split_csv_files/tracks_rapper_part1.csv", genius_token, "./output/lyrics_output1-3.csv")