...
if __name__ == "__main__":
    # Genius API トークンを設定
    genius_token = "PQmwaq_g36OY6s4fWVJ6WH8DAaVdRf906dmy_PoF6_R_5TEo07Vo4rLaVAzFBU6w"  # 適切なトークンを入力してください

    # 関数を実行
    get_lyrics_from_output_csv("./output/split_csv_files/tracks_rapper_part7.csv", genius_token, "./output/lyrics_output7.csv")