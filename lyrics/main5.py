...
if __name__ == "__main__":
    # Genius API トークンを設定
    genius_token = "o02CwNGQoXVoGuD3e7I1cTIPDbohpGfsIWUKU3MPsV3SM02VuxwsZq6pHNfKXF8X"  # 適切なトークンを入力してください

    # 関数を実行
    get_lyrics_from_output_csv("./output/split_csv_files/tracks_rapper_part5.csv", genius_token, "./output/lyrics_output5.csv")