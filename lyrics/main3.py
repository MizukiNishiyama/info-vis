...
if __name__ == "__main__":
    # Genius API トークンを設定
    genius_token = "7_u45pu8gv1HedvLS-fB29UW10Rd7yBPNEA6My-ozR05TnnX831H26jLewE30p06"  # 適切なトークンを入力してください

    # 関数を実行
    get_lyrics_from_output_csv("./output/split_csv_files/tracks_rapper_part3.csv", genius_token, "./output/lyrics_output3-2.csv")