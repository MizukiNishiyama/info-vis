...
if __name__ == "__main__":
    # Genius API トークンを設定
    genius_token = "tcksC0SfPNmuhqPMv0PjQpTAUXM_Hly8k1Arfz0ZaVjzgulScFBvtCJ609kzsoWa"  # 適切なトークンを入力してください

    # 関数を実行
    get_lyrics_from_output_csv("./output/split_csv_files/tracks_rapper_part9.csv", genius_token, "./output/lyrics_output9.csv")