...
if __name__ == "__main__":
    # Genius API トークンを設定
    genius_token = "bnHsgr5ii-WZz-ZIX1nPVF0FkbgpohsXDXyS_rV52DqEna9cIgHBC0bH5noitQKT"  # 適切なトークンを入力してください

    # 関数を実行
    get_lyrics_from_output_csv("./output/split_csv_files/tracks_rapper_part4.csv", genius_token, "./output/lyrics_output4.csv")