...
if __name__ == "__main__":
    # Genius API トークンを設定
    genius_token = "puxmBvWvOGDxQj8YibVVF94X66E-OJzq74XjFbD4X6NDLvgKvdzgZJoXX3DvuzeL"  # 適切なトークンを入力してください

    # 関数を実行
    get_lyrics_from_output_csv("./output/split_csv_files/tracks_rapper_part6.csv", genius_token, "./output/lyrics_output6.csv")